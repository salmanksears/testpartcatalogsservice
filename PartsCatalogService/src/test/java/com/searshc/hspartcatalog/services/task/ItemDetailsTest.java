...
public class ItemDetailsTest {
	...
	private GetItemDetailsRequest request = null; 
	...
	private static final Logger logger = LoggerFactory
			.getLogger(ItemDetailsTest.class);

	@Before
	public void setUp() throws Exception {
		request = new GetItemDetailsRequest();
	...
	@Test
	public final void testGetModelDetails() {
		try {

			GetItemDetailsResponse response = (GetItemDetailsResponse) solrServiceInvokerBO
					.getItemDetails(request, productGroupList,
							availabilityStatusList, attributeList,
							restrictionList, itemSellPriceLimit);
			assertNotNull(response);
			Item item = response.getItem();
			assertNotNull(item);
			logger.debug("Item No >>> {}", item.getItemId());
