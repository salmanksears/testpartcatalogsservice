...
public class ItemDescriptionSearchTest {
	...
	public final void search1() {
		...
		//request.setModelNo("MGDE200XW1");
		//request.setBrand("MAYTAG");
		//request.setProductType("Laundry*");
		//request.setDescription("Power Cord");
		...
		try {
				response = (ItemSearchResponse) solrServiceInvokerBO
						.itemDescriptionSearch(request, productGroupList,
				...
				logger.debug(
				 ...
				 for (Item item : items) {
					 logger.debug("Part No: {} Desc: {}", item.getPartNo(),
