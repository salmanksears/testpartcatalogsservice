...
/**
* Title			:   GetModelListRequestValidator
* Description	:	this class validates GetModelListRequest. Validation includes mandatory params, default values, datatype, 
* 					alpha space, length etc.  
* @author		:	Abhishek Jain
*/

public class GetModelListRequestValidator extends CommonValidator implements Validator<GetModelListRequest>{

	@Override
	public ValidatorOutput validate(GetModelListRequest request) {
