...
/**
* Title			:   GetItemListRequestValidator
* Description	:	this class validates GetItemListRequest. Validation includes mandatory params, default values, datatype, 
* 					alpha space, length etc.  
* @author		:	Abhishek Jain
*/

public class GetItemListRequestValidator extends CommonValidator implements Validator<GetItemListRequest>{

	@Override
	public ValidatorOutput validate(GetItemListRequest request) {
