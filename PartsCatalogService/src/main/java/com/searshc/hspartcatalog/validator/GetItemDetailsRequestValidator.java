...
/**
* Title			:   GetItemDetailsRequestValidator
* Description	:	this class validates GetItemDetailsRequest. Validation includes mandatory params, default values, datatype, 
* 					alpha space, length etc.  
* @author		:	Abhishek Jain
*/
public class GetItemDetailsRequestValidator extends CommonValidator implements Validator<GetItemDetailsRequest>{

	@Override
	public ValidatorOutput validate(GetItemDetailsRequest request) {
