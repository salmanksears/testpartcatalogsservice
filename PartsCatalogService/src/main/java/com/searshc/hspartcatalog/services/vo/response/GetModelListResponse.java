...
/**
* Title			:   GetModelListResponse
* Description	:	this class is pojo for GetModelListResponse 
* @author		:	Abhishek Jain
*/
@XmlRootElement(name="getModelListResponse" , namespace="http://vo.services.hspartcatalog.searshc.com/response/")
@XmlType(propOrder = {
		"numFound",
		"models"})
