...
/**
* Title			:   GetBrandListResponse
* Description	:	this class is pojo for GetBrandListResponse 
* @author		:	Abhishek Jain
*/
@XmlRootElement(name="getBrandListResponse",namespace="http://vo.services.hspartcatalog.searshc.com/response/")
@XmlType(propOrder = {
		"numFound",
		"brands"})
