...
/**
* Title			:   GetParentProductTypeListRequest
* Description	:	this class is pojo for GetParentProductTypeListRequest 
* @author		:	Abhishek Jain
*/
public class GetParentProductTypeListRequest extends BaseRequest{
