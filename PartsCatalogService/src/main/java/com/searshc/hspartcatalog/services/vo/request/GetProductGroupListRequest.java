...
/**
* Title			:   GetProductGroupListRequest
* Description	:	this class is pojo for GetProductGroupListRequest 
* @author		:	Abhishek Jain
*/
public class GetProductGroupListRequest extends BaseRequest{
